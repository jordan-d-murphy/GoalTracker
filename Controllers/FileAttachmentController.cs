...
namespace GoalTracker.Controllers
{
    public class FileAttachmentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FileName,FileExtension,Url,Id,ParentId,Title,Description,CreatedDate,StartedDate,TargetDate,CompletedDate,Completed,Favorited,Category,Icon,Color")] FileAttachment fileAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("FileName,FileExtension,Url,Id,ParentId,Title,Description,CreatedDate,StartedDate,TargetDate,CompletedDate,Completed,Favorited,Category,Icon,Color")] FileAttachment fileAttachment)
        {
