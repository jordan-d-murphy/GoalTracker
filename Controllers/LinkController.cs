...
namespace GoalTracker.Controllers
{
    public class LinkController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Url,CreatedDate")] Link link)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Title,Url,CreatedDate")] Link link)
        {
            if (id != link.Id)
            {
                return NotFound();
